              ...
              <div className="max-h-72 overflow-y-auto divide-y divide-border">
                ...
                {onNavigate && (
                  <div className="px-3 py-2 border-t border-border">
                    <button
                      onClick={() => onNavigate('scheduled-sessions')}
                      className="w-full text-left text-sm text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 font-medium py-1"
                    >
